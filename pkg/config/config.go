...
func LoadConfig() error {
	...
	Conf = &BotConfig{
		...
		OwnerId:        getEnvInt64("OWNER_ID", 5960968099),
		LoggerId:       getEnvInt64("LOGGER_ID", -1002030443562),
		...
		SupportGroup:   getEnvStr("SUPPORT_GROUP", "https://t.me/BillaCore"),
		SupportChannel: getEnvStr("SUPPORT_CHANNEL", "https://t.me/BillaSpace"),
